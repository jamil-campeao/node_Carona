...
var postDestino = exports.postDestino = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, DES_NOME, DES_KM, destinoExistente, destino;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          destinoExistente = _context.sent;
          if (!destinoExistente) {
            _context.next = 7;
            break;
          }
        ...
        case 13:
          ...
          res.status(500).json({
            message: "Erro ao cadastrar novo destino: ".concat(_context.t0)
          });
        case 16:
        case "end":
  ...
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 6:
          return _context2.abrupt("return", res.status(200).json(destinos));
        case 9:
          _context2.prev = 9;
...
var putDestino = exports.putDestino = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var id, _req$body2, DES_NOME, DES_KM, parsedId, destino, updateDestino;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 10:
          updateDestino = _context3.sent;
          if (!updateDestino) {
            _context3.next = 13;
            break;
          }
          return _context3.abrupt("return", res.status(200).json(updateDestino));
        case 13:
          _context3.next = 16;
          break;
        case 15:
        ...
        case 18:
          ...
          return _context3.abrupt("return", res.status(500).json({
            error: "Erro ao alterar dados do destino: ".concat(_context3.t0)
          }));
        case 21:
        case "end":
...
var deleteDestino = exports.deleteDestino = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var id, parsedId, destino, _deleteDestino;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 9:
          _deleteDestino = _context4.sent;
          if (!_deleteDestino) {
            _context4.next = 12;
            break;
          }
          return _context4.abrupt("return", res.status(200).json(_deleteDestino));
        case 12:
          _context4.next = 15;
          break;
        case 14:
        ...
        case 17:
          ...
          return _context4.abrupt("return", res.status(500).json({
            error: "Erro ao inativar destino: ".concat(_context4.t0)
          }));
        case 20:
        case "end":
